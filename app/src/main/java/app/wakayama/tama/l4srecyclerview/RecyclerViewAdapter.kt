...
class RecyclerViewAdapter(private val context: Context):RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>() {
    val items: MutableList<GudeData> = mutableListOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_gudetama_data_cell,parent,false)
    ...
    fun addAll(items: List<GudeData>){
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val charaDetailTextView: TextView = view.findViewById(R.id.descriptionTtextView)
    }
}